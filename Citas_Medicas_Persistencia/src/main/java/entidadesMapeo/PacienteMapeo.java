...
/**
 * Clase que sirve para mapear la entidad Paciente dentro de una base de datos
 */
public class PacienteMapeo {
     ...
     */
    public PacienteMapeo(ObjectId _id, String nombre, String apellidoPaterno, String apellidoMaterno, Date fechaNacimiento, String telefono, String correo, List<DatosFiscales> datosFiscales) {
        this._id = _id;
        this.nombre = nombre;
     ...
     * @param correo Correo del paciente
     */
    public PacienteMapeo(String nombre, String apellidoPaterno, String apellidoMaterno, Date fechaNacimiento, String telefono, String correo) {
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
        this.apellidoMaterno = apellidoMaterno;
        this.fechaNacimiento = fechaNacimiento;
     ...
     * @param datosFiscales Datos fiscales del paciente
     */
    public PacienteMapeo(String nombre, String apellidoPaterno, String apellidoMaterno, Date fechaNacimiento, String telefono, String correo, List<DatosFiscales> datosFiscales) {
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
        this.apellidoMaterno = apellidoMaterno;
        this.fechaNacimiento = fechaNacimiento;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof PacienteMapeo)) {
            return false;
        }
        PacienteMapeo other = (PacienteMapeo) object;
