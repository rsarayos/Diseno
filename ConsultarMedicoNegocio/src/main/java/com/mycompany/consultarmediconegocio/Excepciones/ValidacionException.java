 ...
 *
 * Esta excepción se utiliza para indicar que ha ocurrido un error durante la
 * validación de datos en el sistema.
 *
 */
public class ValidacionException extends Exception {
    ...
    /**
     * Constructor de ValidacionException con un mensaje descriptivo del error y
     * la causa subyacente.
     *
     * @param message El mensaje descriptivo del error.
    ...
    /**
     * Constructor de ValidacionException con un mensaje descriptivo del error,
     * la causa subyacente, y opciones para habilitar la supresión de
     * excepciones y configurar si la traza de la pila es escribible.
     *
     * @param message El mensaje descriptivo del error.
     * @param cause La causa subyacente del error.
